...
var AlgorithmsComponent = /** @class */ (function () {
    ...
    AlgorithmsComponent.prototype.applyFilter = function (filterValue) {
    ...
    ], AlgorithmsComponent.prototype, "paginator", void 0);
...
module.exports = "<!-- <h1>\r\n  Dashboard</h1> -->\r\n<div class=\"dashboardPanel\">\r\n  <div class=\"flex-grid\">\r\n    <div class=\"col\">\r\n      <mat-card class=\"dashboard-card\">\r\n        <mat-card-header>\r\n          <mat-title>Projects Overview</mat-title>\r\n        </mat-card-header>\r\n        <mat-divider></mat-divider>\r\n        <mat-card-content *ngIf=\"projectsArr\">\r\n          <mat-nav-list>\r\n            <mat-list-item *ngFor=\"let project of projectsArr; let i = index\" (click)=\"projectClick(project.id)\" (dblclick)=\"projectDblclick(project.id)\">\r\n              <div class=\"flex space-between list-wrapper\">\r\n                <span> {{project.projectName}}</span>\r\n                <mat-chip-list>\r\n                  <mat-chip [ngStyle]=\"{'backgroundColor':getColor(project.status)}\" selected>{{project.status}}</mat-chip>\r\n                </mat-chip-list>\r\n              </div>\r\n            </mat-list-item>\r\n          </mat-nav-list>\r\n        </mat-card-content>\r\n      </mat-card>\r\n    </div>\r\n    <div class=\"col\">\r\n      <mat-card class=\"dashboard-card\">\r\n        <mat-card-header>\r\n          <mat-title>Datasets Overview</mat-title>\r\n        </mat-card-header>\r\n        <mat-divider></mat-divider>\r\n        <mat-card-content>\r\n          <mat-nav-list>\r\n            <mat-list-item *ngFor=\"let datasets of dataset; let i = index\" (click)=\"datasetClick(datasets.id)\">{{datasets.name}}</mat-list-item>\r\n          </mat-nav-list>\r\n        </mat-card-content>\r\n      </mat-card>\r\n    </div>\r\n    <div class=\"col\">\r\n      <mat-card class=\"dashboard-card\">\r\n        <mat-card-header>\r\n          <mat-title>Analytical Tools Overview</mat-title>\r\n        </mat-card-header>\r\n        <mat-card-content>\r\n          <mat-nav-list>\r\n            <mat-list-item *ngFor=\"let algorithms of algorithm; let i = index\" (click)=\"algorithmClick(algorithms.id)\">{{algorithms.algorithmName}}</mat-list-item>\r\n          </mat-nav-list>\r\n        </mat-card-content>\r\n      </mat-card>\r\n    </div>\r\n  </div>\r\n  <!-- <div class=\"flex-grid\"> -->\r\n  <!-- <div class=\"col\">\r\n            <mat-card class=\"dashboard-card\">\r\n                <mat-title>System Monitor Overview</mat-title>\r\n            </mat-card>\r\n        </div> -->\r\n  <!-- </div> -->\r\n  <div class=\"flex-grid\">\r\n    <div class=\"colFullHeight\">\r\n      <h4>Panel Details</h4>\r\n      <div class=\"panelDetails\">\r\n        <div *ngIf=\"projectDetails && panelProject\">\r\n          <h3>Project Details</h3>\r\n          <table id=\"projectTable\">\r\n            <tbody>\r\n              <tr>\r\n                <td>\r\n                  <strong>Project Id: </strong>\r\n                </td>\r\n                <td>{{projectDetails.project.id}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Project Name: </strong>\r\n                </td>\r\n                <td>{{projectDetails.project.projectName}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Status: </strong>\r\n                </td>\r\n                <td>{{projectDetails.project.status}}</td>\r\n              </tr>\r\n              <tr *ngIf=\"projectDetails.project.description\">\r\n                <td>\r\n                  <strong>Desription: </strong>\r\n                </td>\r\n                <td>{{projectDetails.project.description}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Creation Date: </strong>\r\n                </td>\r\n                <td>{{projectDetails.project.creationDate | date}}</td>\r\n              </tr>\r\n              <tr *ngIf=\"projectDetails.project.lastOpened\">\r\n                <td>\r\n                  <strong>Last Opened: </strong>\r\n                </td>\r\n                <td>{{projectDetails.project.lastOpened | date}}</td>\r\n              </tr>\r\n              <tr *ngIf=\"projectDetails.dataset\">\r\n                <td>\r\n                  <strong>Dataset Name: </strong>\r\n                </td>\r\n                <td>{{projectDetails.dataset.name}}</td>\r\n              </tr>\r\n              <tr *ngIf=\"projectDetails.algorithms.length>0\">\r\n                <td>\r\n                  <strong>Algorithms Name: </strong>\r\n                </td>\r\n                <td>\r\n                  <span *ngFor=\" let al of projectDetails.algorithms; let i = index\">\r\n                    <span class=\"span\" *ngIf=\"i < projectDetails.algorithms.length-1 \">\r\n                      {{al.algorithmName}},\r\n                    </span>\r\n                    <span class=\"span\" *ngIf=\"i == projectDetails.algorithms.length-1 \">\r\n                      {{al.algorithmName}}\r\n                    </span>\r\n\r\n                  </span>\r\n                </td>\r\n              </tr>\r\n            </tbody>\r\n          </table>\r\n          <!-- ***************************** TABLE End**************************************** -->\r\n          <!-- <span>\r\n            <strong>Project Id: </strong><div class=\"ïnfo\"><span>{{projectDetails.project.id}},</span></div></span>\r\n          <br>\r\n          <span>\r\n            <strong>Project Name: </strong> <div class=\"ïnfo\"><span>{{projectDetails.project.projectName}}</span></div></span>\r\n          <br>\r\n          <span>\r\n            <strong>Status: </strong><div class=\"ïnfo\"><span>{{projectDetails.project.status}}</span></div></span>\r\n          <br>\r\n          <span>\r\n            <strong>Desription: </strong><div class=\"ïnfo\"><span>{{projectDetails.project.description}}</span></div></span>\r\n          <br>\r\n          <span>\r\n            <strong>Creation Date: </strong><div class=\"ïnfo\"><span>{{projectDetails.project.creationDate | date}}</span></div></span>\r\n          <br>\r\n          <span *ngIf=\"projectDetails.project.lastOpened\">\r\n            <strong>Last Opened: </strong><div class=\"ïnfo\"><span>{{projectDetails.project.lastOpened | date}}</span></div></span>\r\n          <br>\r\n          <div *ngIf=\"projectDetails.dataset\">\r\n            <strong>Dataset Name: </strong><span class=\"ïnfo\">{{projectDetails.dataset.name}}</span></div>\r\n          <br>\r\n          <div *ngIf=\"projectDetails.algorithms.length>0\">\r\n            <strong>Algorithms Name: </strong>\r\n            <span *ngFor=\" let al of projectDetails.algorithms\"> <div class=\"ïnfo\"><span>{{al.algorithmName}},</span></div></span>\r\n          </div> -->\r\n        </div>\r\n        <div *ngIf=\"data && panelData\">\r\n          <h3>Dataset Details</h3>\r\n          <!-- **************************Table**************************************** -->\r\n          <table>\r\n            <tbody>\r\n              <tr>\r\n                <td>\r\n                  <strong>Dataset Name: </strong>\r\n                </td>\r\n                <td>{{data.datasetName}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Dataset Description: </strong>\r\n                </td>\r\n                <td>{{data.datasetDesc}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Dataset Size: </strong>\r\n                </td>\r\n                <td>{{data.datasetSize}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Number Of Variables: </strong>\r\n                </td>\r\n                <td>{{data.numberOfVariables}}</td>\r\n              </tr>\r\n              <tr>\r\n                <td>\r\n                  <strong>Number Of Rows: </strong>\r\n                </td>\r\n                <td>{{data.numberOfRows}}</td>\r\n              </tr>\r\n            </tbody>\r\n          </table>\r\n          <!-- ********************************END***************************************** -->\r\n          <!-- <span>\r\n            <strong>Dataset Name: </strong>{{data.datasetName}}</span>\r\n          <br>\r\n          <span>\r\n            <strong>Dataset Description: </strong>{{data.datasetDesc}}</span>\r\n          <br>\r\n          <span>\r\n            <strong>Dataset Size: </strong>{{data.datasetSize}}</span>\r\n          <br>\r\n          <span>\r\n            <strong>Number Of Variables: </strong>{{data.numberOfVariables}}</span>\r\n          <br>\r\n          <span>\r\n            <strong>Number Of Rows: </strong>{{data.numberOfRows}}</span> -->\r\n\r\n          <h3>Variable Details</h3>\r\n          <div>\r\n            <table mat-table [dataSource]=\"data.variableDetails\" class=\"mat-elevation-z8\">\r\n\r\n              <ng-container matColumnDef=\"Name\">\r\n                <th mat-header-cell *matHeaderCellDef> Name </th>\r\n                <td mat-cell *matCellDef=\"let element\"> {{element.variableName}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Average\">\r\n                <th mat-header-cell *matHeaderCellDef> Average </th>\r\n                <td mat-cell *matCellDef=\"let element\"> {{element.average}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Distinct Count\">\r\n                <th mat-header-cell *matHeaderCellDef> Distinct Count </th>\r\n                <td mat-cell *matCellDef=\"let element\"> {{element.distinctCount}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Minimum\">\r\n                <th mat-header-cell *matHeaderCellDef> Minimum </th>\r\n                <td mat-cell *matCellDef=\"let element\"> {{element.min}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Maximum\">\r\n                <th mat-header-cell *matHeaderCellDef> Maximum </th>\r\n                <td mat-cell *matCellDef=\"let element\"> {{element.max}} </td>\r\n              </ng-container>\r\n\r\n              <tr mat-header-row *matHeaderRowDef=\"displayedColumns\"></tr>\r\n              <tr mat-row *matRowDef=\"let row; columns: displayedColumns;\"></tr>\r\n            </table>\r\n          </div>\r\n        </div>\r\n        <div *ngIf=\"algo && panelAlgo\">\r\n          <h3>Algorithm Details</h3>\r\n          <!-- ************* Table for algorithms******************** -->\r\n          <table>\r\n            <tr>\r\n              <td>\r\n                <strong>Algorithm Name: </strong>\r\n              </td>\r\n              <td>{{algo.algorithmName}}</td>\r\n            </tr>\r\n            <tr>\r\n              <td>\r\n                <strong>Description: </strong>\r\n              </td>\r\n              <td>{{algo.description}}</td>\r\n            </tr>\r\n            <tr>\r\n              <td>\r\n                <strong>Library: </strong>\r\n              </td>\r\n              <td>{{algo.library}}</td>\r\n            </tr>\r\n          </table>\r\n          <!-- ***************************end************************ -->\r\n          <!-- <span>\r\n            <strong>Algorithm Name: </strong>{{algo.algorithmName}}</span>\r\n          <br>\r\n          <span>\r\n            <strong>Description: </strong>{{algo.description}}</span>\r\n          <br>\r\n          <span>\r\n            <strong>Library: </strong>{{algo.library}}</span> -->\r\n\r\n          <div *ngIf=\"algo.parameters.length>0\">\r\n            <h3>Parameters Details</h3>\r\n            <table mat-table [dataSource]=\"algo.parameters\" class=\"mat-elevation-z8\">\r\n\r\n              <ng-container matColumnDef=\"Parameter Name\">\r\n                <th mat-header-cell *matHeaderCellDef> Parameter Name </th>\r\n                <td mat-cell *matCellDef=\"let param\"> {{param.parameterName}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Default Value\">\r\n                <th mat-header-cell *matHeaderCellDef> Default Value </th>\r\n                <td mat-cell *matCellDef=\"let param\"> {{param.defaultValue}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Value Type\">\r\n                <th mat-header-cell *matHeaderCellDef> Value Type </th>\r\n                <td mat-cell *matCellDef=\"let param\"> {{param.parameterValueType}} </td>\r\n              </ng-container>\r\n\r\n              <ng-container matColumnDef=\"Parameter Value\">\r\n                <th mat-header-cell *matHeaderCellDef> Parameter Value </th>\r\n                <td mat-cell *matCellDef=\"let param\">\r\n                  <span *ngIf=\"param.parameterValues\">{{param.parameterValues}}</span>\r\n                </td>\r\n              </ng-container>\r\n              <tr mat-header-row *matHeaderRowDef=\"displayedColumn\"></tr>\r\n              <tr mat-row *matRowDef=\"let row; columns: displayedColumn;\"></tr>\r\n            </table>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n"
...
module.exports = ".flex {\n  display: flex; }\n\n.column {\n  flex-direction: column; }\n\n.center {\n  align-items: center;\n  justify-content: center; }\n\n.space-around {\n  justify-content: space-around; }\n\n.space-between {\n  justify-content: space-between; }\n\n.wrap {\n  flex-wrap: wrap; }\n\n.align-items-center {\n  align-items: center; }\n\n.justify {\n  text-align: justify; }\n\n.subtitle {\n  color: #757575; }\n\n.warn-message {\n  color: #FF3D00;\n  margin-top: 30px;\n  font-size: 18px; }\n\n.navContainer {\n  width: 100%;\n  height: 89vh; }\n\n.sideContent {\n  width: 20%;\n  padding-top: 35px; }\n\nmat-nav-list a mat-icon {\n  padding-left: 25px; }\n\n.userDetail {\n  padding-left: 40px;\n  margin-bottom: 40px; }\n\n.logout {\n  margin-top: 45vh; }\n\n.header-username {\n  color: #fff;\n  font-size: 17px;\n  padding-right: 100px; }\n\n.header {\n  overflow: hidden;\n  background: linear-gradient(to right, #00897B, #4DB6AC);\n  padding: 20px 10px; }\n\n.header a {\n  float: left;\n  color: white;\n  text-align: center;\n  padding: 12px;\n  text-decoration: none;\n  font-size: 18px;\n  line-height: 25px;\n  border-radius: 4px; }\n\n.header a.logo {\n  font-size: 25px;\n  font-weight: bold; }\n\n.mat-nav-list a.active {\n  background: #EAFFD1; }\n\n.mat-nav-list a span {\n  padding-left: 12px; }\n\nmat-icon {\n  color: #00897B; }\n\n.add-mini-fab-btn {\n  color: #fff; }\n\n.dashboardPanel {\n  width: 96%;\n  margin-left: 2%;\n  display: flex;\n  flex-direction: row;\n  margin-top: 3%; }\n\ntable {\n  width: 100%; }\n\nh1 {\n  margin-left: 2%;\n  color: #757575; }\n\nh3 {\n  color: #4DB6AC; }\n\nh4 {\n  background-color: #00897B;\n  padding: 20px 30px;\n  color: white;\n  font-weight: 100;\n  margin-top: 0; }\n\n.flex-grid {\n  width: 95%;\n  flex-direction: column;\n  justify-content: space-between; }\n\n.col {\n  border-width: 1px;\n  border-style: groove;\n  border-color: #e1f5fe;\n  margin: 0 0 6px 0; }\n\n.colFullHeight::-moz-selection,\nh3::-moz-selection,\nh4::-moz-selection,\nspan::-moz-selection,\nstrong::-moz-selection,\ntd::-moz-selection,\nth::-moz-selection {\n  background: #00897B;\n  color: white; }\n\n.colFullHeight::selection,\nh3::selection,\nh4::selection,\nspan::selection,\nstrong::selection,\ntd::selection,\nth::selection {\n  background: #00897B;\n  color: white; }\n\n.colFullHeight {\n  width: 100%;\n  height: 793px;\n  max-height: 793px;\n  min-height: 793px;\n  border-width: 1px;\n  border-style: groove;\n  border-color: #e1f5fe;\n  margin-left: 2%;\n  background-color: white; }\n\n.panelDetails {\n  padding: 0 30px; }\n\nstrong {\n  margin-right: 5px;\n  color: #424242;\n  font-size: 16px; }\n\nspan {\n  font-size: 16px; }\n\ntbody tr td:first-child {\n  width: 11em;\n  font-weight: normal; }\n\n#projectTable tr,\ntd,\n.span {\n  font-family: Roboto, 'Helvetica Neue', sans-serif;\n  font-size: 14px;\n  font-weight: 500; }\n\nmat-card {\n  padding: 0 !important;\n  box-shadow: none !important;\n  font-size: 16px; }\n\nmat-card-header {\n  background: #00897B !important;\n  color: white !important;\n  padding: 20px; }\n\nmat-card-content {\n  padding: 5px 25px;\n  max-height: 190px;\n  min-height: 190px;\n  overflow-y: scroll; }\n\n.list-wrapper {\n  width: 100%;\n  align-items: center; }\n\n@media (max-width: 400px) {\n  .flex-grid {\n    display: block; }\n  .col {\n    margin-top: 1%;\n    width: 100%; } }\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dashboardService, _router, sharedService) {
        ...
        this.displayedColumn = ['Parameter Name', 'Default Value', 'Value Type', 'Parameter Value'];
    }
    ...
    DashboardComponent.prototype.projectClick = function (id) {
        var _this = this;
    ...
    DashboardComponent.prototype.datasetClick = function (id) {
        var _this = this;
        this.panelData = true;
        this.panelProject = false;
        this.panelAlgo = false;
...
module.exports = ".flex {\n  display: flex; }\n\n.column {\n  flex-direction: column; }\n\n.center {\n  align-items: center;\n  justify-content: center; }\n\n.space-around {\n  justify-content: space-around; }\n\n.space-between {\n  justify-content: space-between; }\n\n.wrap {\n  flex-wrap: wrap; }\n\n.align-items-center {\n  align-items: center; }\n\n.justify {\n  text-align: justify; }\n\n.subtitle {\n  color: #757575; }\n\n.warn-message {\n  color: #FF3D00;\n  margin-top: 30px;\n  font-size: 18px; }\n\n.navContainer {\n  width: 100%;\n  height: 89vh; }\n\n.sideContent {\n  width: 20%;\n  padding-top: 35px; }\n\nmat-nav-list a mat-icon {\n  padding-left: 25px; }\n\n.userDetail {\n  padding-left: 40px;\n  margin-bottom: 40px; }\n\n.logout {\n  margin-top: 45vh; }\n\n.header-username {\n  color: #fff;\n  font-size: 17px;\n  padding-right: 100px; }\n\n.header {\n  overflow: hidden;\n  background: linear-gradient(to right, #00897B, #4DB6AC);\n  padding: 20px 10px; }\n\n.header a {\n  float: left;\n  color: white;\n  text-align: center;\n  padding: 12px;\n  text-decoration: none;\n  font-size: 18px;\n  line-height: 25px;\n  border-radius: 4px; }\n\n.header a.logo {\n  font-size: 25px;\n  font-weight: bold; }\n\n.mat-nav-list a.active {\n  background: #EAFFD1; }\n\n.mat-nav-list a span {\n  padding-left: 12px; }\n\nmat-icon {\n  color: #00897B; }\n\n.add-mini-fab-btn {\n  color: #fff; }\n\n#data-tab {\n  margin: 5% 10%; }\n\n#data-tab .border {\n    border: 1px solid #E0E0E0;\n    padding: 50px; }\n\n#data-tab .info-box {\n    padding: 50px;\n    width: 400px;\n    margin: 0 20px; }\n\n#data-tab .title-bar {\n    margin-bottom: 20px; }\n\n#data-tab .details-item {\n    margin: 10px 0;\n    padding: 25px 20px;\n    color: #757575;\n    font-size: 17px;\n    border: 2px dotted #FF3D00;\n    border-radius: 3px;\n    width: 40%; }\n\n#data-tab .details-item-dark {\n    margin: 10px 0;\n    padding: 30px 25px;\n    color: #fff;\n    font-size: 15px;\n    background-color: #00897B;\n    border-radius: 3px; }\n\n#data-tab .details-item-dark strong {\n    color: white !important; }\n\n#data-tab .op-title {\n    color: #757575;\n    margin: 30px 0; }\n\n#data-tab .variables {\n    width: 100%; }\n\n#data-tab .variables-box {\n    margin-bottom: 30px;\n    border: 1px solid #757575;\n    border-radius: 3px;\n    padding: 20px;\n    width: 90%; }\n\n#data-tab .header-style {\n    color: #4DB6AC;\n    font-weight: bold;\n    font-size: 17px;\n    margin: 10px 0; }\n\n#data-tab .column-style > span {\n    width: 16%; }\n\n#data-tab .processing-title {\n    color: #00897B;\n    margin-top: 20px;\n    font-size: 18px;\n    width: 158px;\n    font-weight: bold; }\n\n#data-tab .variable-items > span {\n    width: 150px;\n    padding: 20px 0;\n    font-size: 16px; }\n\n#data-tab .params {\n    padding: 0 !important;\n    font-size: 16px !important;\n    display: flex;\n    align-items: center; }\n\n#data-tab .mat-form-field-infix {\n    width: 150px !important; }\n\n#data-tab .small-input {\n    width: 45px !important;\n    margin-right: 10px; }\n\n#data-tab .buttons {\n    margin-top: 40px; }\n\n#data-tab button {\n    float: right;\n    margin-left: 10px; }\n"
...
var DataTabComponent = /** @class */ (function () {
    ...
    DataTabComponent.prototype.getVariables = function () {
        ...
        this.dataTabService.getVariables(this.datasetId)
            ...
            _this.setOperationTypes();
            _this.setTypeOfOperation();
    ...
    DataTabComponent.prototype.test = function () {
    ...
    DataTabComponent.prototype.setTypeOfOperation = function () {
    ...
    DataTabComponent.prototype.setParams = function (value, index) {
        switch (value) {
...
var DatasetComponent = /** @class */ (function () {
    ...
    ], DatasetComponent.prototype, "paginator", void 0);
...
module.exports = "<div id=\"deleteDialog\">\r\n    <h1 class=\"subtitle\" mat-dialog-title>Delete {{data.type}}</h1>\r\n    <mat-divider></mat-divider>\r\n    <mat-dialog-content>Are you sure you want to delete {{data.type}} {{data.name}}?</mat-dialog-content>\r\n    <mat-dialog-actions>\r\n        <button mat-stroked-button color=\"warn\" mat-dialog-close (click)=\"cancel()\">Cancel</button>\r\n        <button mat-raised-button color=\"primary\" [mat-dialog-close]=\"true\">Yes</button>\r\n    </mat-dialog-actions>\r\n</div>"
...
module.exports = ".flex {\n  display: flex; }\n\n.column {\n  flex-direction: column; }\n\n.center {\n  align-items: center;\n  justify-content: center; }\n\n.space-around {\n  justify-content: space-around; }\n\n.space-between {\n  justify-content: space-between; }\n\n.wrap {\n  flex-wrap: wrap; }\n\n.align-items-center {\n  align-items: center; }\n\n.justify {\n  text-align: justify; }\n\n.subtitle {\n  color: #757575; }\n\n.warn-message {\n  color: #FF3D00;\n  margin-top: 30px;\n  font-size: 18px; }\n\n.navContainer {\n  width: 100%;\n  height: 89vh; }\n\n.sideContent {\n  width: 20%;\n  padding-top: 35px; }\n\nmat-nav-list a mat-icon {\n  padding-left: 25px; }\n\n.userDetail {\n  padding-left: 40px;\n  margin-bottom: 40px; }\n\n.logout {\n  margin-top: 45vh; }\n\n.header-username {\n  color: #fff;\n  font-size: 17px;\n  padding-right: 100px; }\n\n.header {\n  overflow: hidden;\n  background: linear-gradient(to right, #00897B, #4DB6AC);\n  padding: 20px 10px; }\n\n.header a {\n  float: left;\n  color: white;\n  text-align: center;\n  padding: 12px;\n  text-decoration: none;\n  font-size: 18px;\n  line-height: 25px;\n  border-radius: 4px; }\n\n.header a.logo {\n  font-size: 25px;\n  font-weight: bold; }\n\n.mat-nav-list a.active {\n  background: #EAFFD1; }\n\n.mat-nav-list a span {\n  padding-left: 12px; }\n\nmat-icon {\n  color: #00897B; }\n\n.add-mini-fab-btn {\n  color: #fff; }\n\n#deleteDialog mat-dialog-content {\n  padding: 50px 30px 20px 30px;\n  font-size: 20px; }\n\n#deleteDialog mat-dialog-actions {\n  display: flex;\n  align-items: center;\n  justify-content: flex-end; }\n\n#deleteDialog mat-dialog-actions > button {\n  margin-top: 30px;\n  margin-left: 15px; }\n"
...
module.exports = "<div id=\"loginBgr\">\r\n    <div class=\"logImg wrap flex center\">\r\n        <img src=\"CustomerProfiling/src/assets/usr.png\">\r\n    </div>\r\n    <mat-card *ngIf=\"loginCard\" class=\"loginCard wrap\">\r\n        <mat-card-title>LOGIN</mat-card-title>\r\n        <form class=\"loginForm flex column space-around\" [formGroup]=\"loginForm\" (ngSubmit)=\"login()\">\r\n            <div class=\"flex column space-around\">\r\n                <mat-form-field class=\"loginFormField\">\r\n                    <input matInput placeholder=\"Username*\" formControlName=\"username\" [(ngModel)]=\"username\">\r\n                </mat-form-field>\r\n                <mat-error class=\"loginFormField\" *ngIf=\"loginForm.get('username').touched && loginForm.get('username').hasError('required')\">\r\n                    Username is required.\r\n                </mat-error>\r\n                <mat-form-field class=\"loginFormField\">\r\n                    <input matInput placeholder=\"Password*\" type=\"password\" formControlName=\"password\" [(ngModel)]=\"password\">\r\n                </mat-form-field>\r\n                <mat-error class=\"loginFormField\" *ngIf=\"loginForm.get('password').touched && loginForm.get('password').hasError('required')\">\r\n                    Password is required.\r\n                </mat-error>\r\n            </div>\r\n            <mat-card-actions class=\"loginActions flex\">\r\n                <button color=\"warn\" mat-raised-button [disabled]=\"loginForm.invalid\">SIGN IN</button>\r\n                <button mat-stroked-button class=\"signUp\" (click)=\"openSignup()\">SIGN UP</button>\r\n            </mat-card-actions>\r\n        </form>\r\n    </mat-card>\r\n    <mat-card *ngIf=\"signup\" class=\"loginCard wrap\">\r\n        <mat-card-title>SIGN UP</mat-card-title>\r\n        <form class=\"signupForm flex column\" [formGroup]=\"signupForm\" (ngSubmit)=\"signupSubmit()\">\r\n            <div class=\"flex\">\r\n                <!-- FIRST COLUMN -->\r\n                <div class=\"signup-columns flex column space-between\">\r\n                    <mat-form-field class=\"signupFormField\">\r\n                        <input matInput placeholder=\"First Name\" formControlName=\"firstName\" autocomplete=\"off\">\r\n                    </mat-form-field>\r\n                    <mat-error class=\"sign-up-error\" *ngIf=\"signupForm.get('firstName').touched && signupForm.get('firstName').hasError('required')\">\r\n                        First Name is required!\r\n                    </mat-error>\r\n                    <mat-form-field class=\"signupFormField\">\r\n                        <input matInput placeholder=\"Last Name\" formControlName=\"lastName\" autocomplete=\"off\">\r\n                    </mat-form-field>\r\n                    <mat-error class=\"sign-up-error\" *ngIf=\"signupForm.get('lastName').touched && signupForm.get('lastName').hasError('required')\">\r\n                        Last Name is required!\r\n                    </mat-error>\r\n                    <mat-form-field class=\"signupFormField\">\r\n                        <input matInput placeholder=\"Email\" formControlName=\"email\" autocomplete=\"off\">\r\n                        <mat-error class=\"sign-up-error\" *ngIf=\"signupForm.get('email').touched && signupForm.get('email').hasError('required')\">\r\n                            Please enter a valid email address\r\n                        </mat-error>\r\n                    </mat-form-field>\r\n                </div>\r\n                <div class=\"signup-columns flex column\">\r\n                    <mat-form-field class=\"signupFormField\">\r\n                        <input matInput placeholder=\"Username*\" formControlName=\"username\" autocomplete=\"off\">\r\n                    </mat-form-field>\r\n                    <mat-error class=\"sign-up-error\" *ngIf=\"signupForm.get('username').touched && signupForm.get('username').hasError('required')\">\r\n                        Username is required!\r\n                    </mat-error>\r\n                    <mat-form-field class=\"signupFormField\">\r\n                        <input matInput placeholder=\"Password*\" type=\"password\" formControlName=\"password\" autocomplete=\"off\">\r\n                    </mat-form-field>\r\n                    <mat-error class=\"sign-up-error\" *ngIf=\"signupForm.get('password').touched && signupForm.get('password').hasError('required')\">\r\n                        Password is required!\r\n                    </mat-error>\r\n                    <mat-form-field class=\"signupFormField\">\r\n                        <input matInput placeholder=\"Repeat Password*\" type=\"password\" formControlName=\"repeatPassword\" autocomplete=\"off\">\r\n                    </mat-form-field>\r\n                    <mat-error class=\"sign-up-error\" *ngIf=\"dontMatch\">\r\n                        Passwords don't match.\r\n                    </mat-error>\r\n                </div>\r\n            </div>\r\n            <mat-card-actions class=\"signUpActions flex\">\r\n                <button mat-stroked-button class=\"back-btn\" color=\"accent\" (click)=\"openLogin()\">Back to Login</button>\r\n                <div>\r\n                    <button mat-raised-button color=\"warn\" (click)=\"resetForm()\">RESET</button>\r\n                    <button mat-raised-button color=\"primary\" [disabled]=\"signupForm.invalid\">SUBMIT</button>\r\n                </div>\r\n            </mat-card-actions>\r\n        </form>\r\n    </mat-card>\r\n</div>"
...
/* harmony import */ var _shared_services_snackbar_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/services/snackbar.service */ "./src/app/shared/services/snackbar.service.ts");
/* harmony import */ var _shared_services_sign_up_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/services/sign-up.service */ "./src/app/shared/services/sign-up.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_formBuilder, _router, _auth, _snackBarService, signUpService) {
        this._formBuilder = _formBuilder;
        this._router = _router;
        this._auth = _auth;
        this._snackBarService = _snackBarService;
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
            ...
            _shared_services_snackbar_service__WEBPACK_IMPORTED_MODULE_4__["SnackBarService"],
            _shared_services_sign_up_service__WEBPACK_IMPORTED_MODULE_5__["SignUpService"]])
    ], LoginComponent);
...
module.exports = "#one-project {\n  padding: 50px 0; }\n  #one-project mat-tab-group {\n    width: 90%; }\n  #one-project .mat-stroked-button {\n    align-self: flex-start !important;\n    margin-left: 5%;\n    margin-bottom: 25px; }\n  #one-project .mat-raised-button {\n    align-self: flex-end !important;\n    margin-left: 5%;\n    margin-bottom: 25px; }\n"
...
var ProjectOverviewService = /** @class */ (function () {
    ...
    ProjectOverviewService.prototype.linkDatasetProject = function (projectId, datasetId) {
...
var ProjectsComponent = /** @class */ (function () {
    ...
    // open delete dialog
    ProjectsComponent.prototype.openDeleteDialog = function (item) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (res) {
            if (res) {
                _this.projectsService.deleteProject(item.id).subscribe(function (res) {
                    _this.snackbar.openSnackBar(res['message'], 'Success');
                    _this.getProjects();
                }, function (err) {
                    _this.snackbar.openSnackBar(err['message'], 'Error');
...
var QueryResultDetailsComponent = /** @class */ (function () {
    ...
    QueryResultDetailsComponent.prototype.ngOnInit = function () {
    };
...
var AuthInterceptor = /** @class */ (function () {
    function AuthInterceptor(auth, _router) {
        this.auth = auth;
        this._router = _router;
    }
    ...
    AuthInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], AuthInterceptor);
...
var SignUpService = /** @class */ (function () {
    function SignUpService(_http) {
        this._http = _http;
        this.baseUrl = '/CustomerProfiling/rest/user';
    }
    SignUpService.prototype.signup = function (obj) {
        return this._http.post(this.baseUrl, obj);
    };
